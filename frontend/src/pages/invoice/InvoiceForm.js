...
const InvoiceForm = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-100 py-8 transition-all duration-500 ${isFullscreen ? 'fixed inset-0 z-50' : ''}`}>
      {/* Animated background */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-tr from-indigo-400/10 to-pink-400/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>
        ...
        <div>
            ...
            {isEdit ? 'Edit Invoice' : 'Create New Invoice'}
              ...
              <div className="flex flex-wrap items-center space-x-3">
                {/* Auto-save indicator */}
                {isAutoSaving && (
                  <div className="flex items-center space-x-2 px-3 py-2 bg-blue-100 text-blue-700 rounded-lg text-sm font-medium">
              ...
              <div className="flex items-center justify-center space-x-8">
                {[
                  ...
                  <div key={step.step} className="flex items-center">
                    ...
                    {index < 2 && (
                      <FiChevronRight className="h-5 w-5 text-gray-400 mx-4" />
                    )}
                  </div>
                ))}
              </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm">Enter your client's details</p>
                </div>
              </div>
            </div>
            <div className="p-6">
              ...
              <div>
                ...
                <input
                  ...
                  type="email"
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 hover:border-gray-300"
              ...
              <div>
                ...
                <textarea
                  {...register('client.address')}
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 hover:border-gray-300 resize-none"
                      rows="4"
            ...
            <div className="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-green-100 text-sm">Set invoice dates and timeline</p>
                </div>
              </div>
          </div>
            <div className="p-6">
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
            <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-rose-600 px-8 py-6">
              <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-4 lg:space-y-0">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-purple-100 text-sm">Add products or services to your invoice</p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap items-center space-x-3">
                  ...
                  <div className="relative group">
                    <button className="bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-xl transition-all duration-200 flex items-center space-x-2 font-medium backdrop-blur-sm">
                      <FiZap className="h-4 w-4" />
                      <span>Smart Add</span>
                    </button>
                    <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-200 opacity-0 group-hover:opacity-100 transition-all duration-300 z-50">
                      <div className="p-4">
                        <h4 className="font-semibold text-gray-900 mb-3">Quick Add Items</h4>
                        {smartSuggestions.map((suggestion, index) => (
                          <button
                            key={index}
                            className="w-full flex items-center space-x-3 p-3 hover:bg-gray-50 rounded-lg transition-colors duration-200"
                          >
                            <suggestion.icon className="h-5 w-5 text-gray-600" />
              ...
              <button
                type="button"
                onClick={addLineItem}
                    className="bg-gradient-to-r from-white/30 to-white/20 hover:from-white/40 hover:to-white/30 text-white px-6 py-3 rounded-xl transition-all duration-200 flex items-center space-x-2 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 backdrop-blur-sm"
              >
                      ...
                      <td className="px-6 py-4">
                        <input
                          ...
                          onChange={(e) => updateLineItem(index, 'quantity', parseFloat(e.target.value) || 0)}
                            className="w-24 px-3 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-200 hover:border-gray-300 text-center"
                          min="0"
                          step="0.01"
                        />
                      </td>
                      <td className="px-6 py-4">
                        ...
                        <input
                          ...
                          onChange={(e) => updateLineItem(index, 'rate', parseFloat(e.target.value) || 0)}
                              className="w-28 pl-8 pr-3 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-200 hover:border-gray-300"
                          min="0"
                          step="0.01"
                        />
                          </div>
